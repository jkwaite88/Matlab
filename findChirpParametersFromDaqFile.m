...
fseek(fid, 0,"eof");
defaultSampsToRead = floor(ftell(fid)/2);
fseek(fid, 0,"bof");
%limit the amount of data to read
if defaultSampsToRead > 10000000
    defaultSampsToRead = 10000000;
end
samplesToProcess = defaultSampsToRead - 5000; % so we don't index past the end of the array below

[data, numRead] = fread(fid, defaultSampsToRead, 'int16');
fclose(fid);
