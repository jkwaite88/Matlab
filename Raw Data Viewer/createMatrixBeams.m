function [binBeamPatches,AnglesLeftToRight,HalfBeamWidthsLeftToRight, CartesianLookupTable] =...
    createMatrixBeams(FT_PER_BIN,NUM_RANGE_BINS, sensorHeight,axis_handle,...
    use_gap)
% binBeamPatches = createMatrixBeams(FT_PER_BIN,NUM_RANGE_BINS, sensorHeight,...
%                                                             axis_handle);
%
% This function draws the patchs for each cell in the Matrix image.
%
% Written by Steven Reeves
% March 12, 2013

NUM_BEAMS             = 16;
AVERAGE_TARGET_HEIGHT = 3;
% define the beam angles and widths
if use_gap
